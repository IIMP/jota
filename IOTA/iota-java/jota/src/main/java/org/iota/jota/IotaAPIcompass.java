 ...
 *
 */
public class IotaAPIcompass extends IotaAPICore {

    private static final Logger log = LoggerFactory.getLogger(IotaAPI.class);

    protected IotaAPIcompass(ApiOptions options) {
        super(options);
    }

    protected IotaAPIcompass(Builder builder) {
    ...
    public List<Transaction> sendTrytes(String[] trytes, int depth, int minWeightMagnitude, String reference) throws ArgumentException {
        GetTransactionsToApproveResponsecompass txs = getTransactionsToApprovecompass(depth, reference);
    ...
    public List<Transaction> promoteTransaction(String tail, int depth, int minWeightMagnitude, Bundle bundle) throws BaseException {
        ...
        GetTransactionsToApproveResponsecompass transactionsToApprove = getTransactionsToApprovecompass(depth, tail);
    ...
    public static class Builder extends ApiBuilder<Builder, IotaAPIcompass> {
        
        @Override
        protected IotaAPIcompass compile() {
            return new IotaAPIcompass(this);
        }
    }
}
