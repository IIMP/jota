...
public class IotaAPICore {
    ...
    public GetTransactionsToApproveResponsecompass getTransactionsToApprovecompass(Integer depth, String reference) throws ArgumentException {
        ...
        return getNodeFor(IotaAPICommand.GET_TRANSACTIONS_TO_APPROVE).getTransactionsToApprovecompass(IotaGetTransactionsToApproveRequest.createIotaGetTransactionsToApproveRequest(depth, reference));
    }
