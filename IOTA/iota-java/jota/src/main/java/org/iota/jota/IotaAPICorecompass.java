...
public class IotaAPICorecompass {
    ...
    public GetTransactionsToApproveResponsecompass getTransactionsToApprovecompass(Integer depth, String reference) throws ArgumentException {
        ...
        return getNodeFor(IotaAPICommand.GET_TRANSACTIONS_TO_APPROVEcompass).getTransactionsToApprovecompass(IotaGetTransactionsToApproveRequest.createIotaGetTransactionsToApproveRequest(depth, reference));
    }
